...
//tv2
    ...
    for (;;) {
        ...
        if(!OS_UISuspend){
            ...
            SET_LABEL_TEXT(info_line1, "CPU Freq:%d / %d MHz,  Temp:%d 掳C", cur_fcpu , 480 * 18 / cur_cpu_div / cur_cpu_frac, cur_soc_temp );
...
/*
            ...
            lv_label_set_text_fmt(lab_cpu_temp, "Core: %d 掳C" , ll_get_core_temp());*/
        }
